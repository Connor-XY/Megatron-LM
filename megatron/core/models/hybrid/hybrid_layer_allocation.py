...
class Symbols:
    ...
    PIPE = '|'
    MTP_SEPARATOR = "/"
    # Bracket grammar used to group component symbols into a single
    # combined decoder layer (see ``combined_layer_pattern.py``). The bracket
    # characters are only valid in main patterns.
    LBRACKET = "["
    RBRACKET = "]"
