#!/bin/bash
#SBATCH -A nemotron_sw_pre -p batch -q short --nodes=16 --gres=gpu:4 --ntasks-per-node=4 -t 1:50:00 -J hybpp2v2w3teB
...
export MODEL=hybrid FSDP=0 TP_OVERRIDE=1 CUDA_GRAPH=te CG_WARMUP=3 GBS=512 EXIT_INTERVAL=80
...
export RANKS_PER_NVL_DOMAIN=32 RUNTAG=hybrid_ep32pp2vpp2_w3
