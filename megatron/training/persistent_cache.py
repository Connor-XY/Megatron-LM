...
Bootstrapping (seeding /tmp from cache_read/<scope>.tar.zst, exporting env
vars) is done by tools/persistent_cache/bootstrap.sh BEFORE this Python process
...
# 'dataset_idx' is CLI-driven (--data-cache-path), not env-driven.
# 'te_fp8' is library-internal, not configured here.
_SCOPE_ENV = {
