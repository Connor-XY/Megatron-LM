...
def _gtp_pre_init(
    ...
    *,
    ...
    gtp_ctx = (gtp_remat_group, gtp_remat_rs_group, pad_length, output_size)
...
def _gtp_attach_post_init(module, gtp_ctx, is_grouped=False):
    ...
    gtp_remat_group, gtp_remat_rs_group, pad_length, logical_out_features = gtp_ctx
    ...
    attach_gtp_to_presharded_module(
        module, gtp_remat_group, pad_length, is_grouped=is_grouped, rs_group=gtp_remat_rs_group
    )
...
class TELinear(te.pytorch.Linear):
    ...
    def __init__(
        ...
        *,
        ...
        gtp_remat_rs_group: Optional[torch.distributed.ProcessGroup] = None,
    ):
        """
        Args:
    ...
    def __init__(
        ...
        *,
        ...
        pg_collection = ProcessGroupCollection.use_mpu_process_groups(
            required_pgs=["gtp_remat", "gtp_remat_rs", "expt_gtp_remat", "expt_gtp_remat_rs"]
        )
        gtp_remat_group = pg_collection.expt_gtp_remat if is_expert else pg_collection.gtp_remat
        gtp_remat_rs_group = (
            pg_collection.expt_gtp_remat_rs if is_expert else pg_collection.gtp_remat_rs
        )
        self.stride = stride
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            gtp_remat_rs_group=gtp_remat_rs_group,
        )
    ...
    class TEGroupedLinear(te.pytorch.GroupedLinear):
        ...
        def __init__(
            ...
            *,
            ...
            gtp_remat_rs_group = pg_collection.expt_gtp_remat_rs
            if gtp_remat_rs_group is None:
                gtp_remat_rs_group = gtp_remat_group
